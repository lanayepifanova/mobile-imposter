  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="text-center mb-10 space-y-3">
        <h2 className="text-4xl font-playfair font-bold text-stone-800">First Speaker</h2>
        <p className="text-stone-500 font-lato">
          Randomly selected to start describing the word.
        </p>
      </div>

      <GlassCard className="w-full p-10 text-center space-y-6 bg-white shadow-xl border-stone-100">
        <div className="mx-auto w-20 h-20 rounded-full bg-stone-50 flex items-center justify-center">
          <Sparkles className="w-8 h-8 text-stone-500" />
        </div>
        <div className="space-y-2">
          <p className="text-xs text-stone-400 uppercase tracking-widest font-lato">You go first</p>
          <p className="text-4xl font-playfair font-bold text-stone-800">{startingName}</p>
        </div>
      </GlassCard>
